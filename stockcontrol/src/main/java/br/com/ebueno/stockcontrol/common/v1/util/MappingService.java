...
public class MappingService {
     ...
     * @return an instance of type D that is a converted version of the source
     *         object
     */
    ...
    /***
     * Converts a list of objects of type S to a list of objects of type D using
     * ModelMapper.
     * 
     * @param <S>             source type to be converted
     * @param <D>             destination type to be converted
     ...
     * @return a list of instances of type D that are converted versions of the
     *         source objects
     */
    ...
    /***
     * Converts a Page of objects of type S to a Page of objects of type D using
     * ModelMapper.
     * 
     * @param <S>             source type to be converted
     * @param <D>             destination type to be converted
     ...
     * @param destinationType the class type of the destination objects
     * @return a Page of instances of type D that are converted versions of the
     *         source objects
     */
